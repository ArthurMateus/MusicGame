...
def One():
    MR = '''When the morning came we were cleaning incense off your vinyl shelf
...
It was maroon'''
    return MR
def Two():
    AH = '''I have this thing where I get older but just never wiser
...
You always have been'''
    return YO
def Five():
    MR = '''Rain, he wanted it comfortable
I wanted that pain
He wanted a bride
...
'''
    return MR
def Six():
    Que = '''Good girl, sad boy, big city, wrong choices
...
It's just a question'''
    return Que
def Seven():
    VS = '''Draw the cat eye, sharp enough to kill a man
...
Lately I've been dressing for revenge'''
    return VS
def Eight():
    BJ = '''Baby love, I think I've been a little too kind
...
I can still make the whole place shimmer'''
    return BJ
def Nine():
    lab = '''It only hurts this much right now
...
How'd you turn it right around'''
    return lab
def Ten():
    Kar = '''You're talking shit for the hell of it
...
Karma's a relaxing thought'''
    return Kar
def Eleven():
    SN = '''I spy with my little tired eye
Tiny as a firefly
...
All that you ever wanted from me was sweet nothing'''
    return SN
def Twelve():
    MM = '''Once upon a time, the planets and the fates
